                            ...
                            @foreach ($files as $file)
                                ...
                                {{-- <a href="{{ route('download',$file['path']) }}"
                                    ...
                                    <form action="{{ route('download')}}" method="POST">
                                        ...
                                        <a href="#" onclick="this.parentNode.submit()" class="block text-center px-4 py-2 border-b border-gray-200 cursor-pointer hover:bg-gray-100 hover:text-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:text-blue-700">
                                            {{ $file['name'] }}
                                        </a>
                                        </form>
                            @endforeach
